...
import { ProfileQueryKeys, useUpdateMeRequest } from "~/modules/profile/service";
...
export default function EditProfile() {
  ...
  return (
      <div>
        ...
        <Dialog header="Редактирование профиля" visible={visible} style={{ width: '50vw' }} onHide={() => {if (!visible) return; setVisible(false); }}>
